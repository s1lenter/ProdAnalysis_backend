...
namespace ProductionAnalysisBackend.Migrations
{
    ...
    [Migration("20260118163032_AddRelationshipProducttoPA")]
    partial class AddRelationshipProducttoPA
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProductionAnalysisBackend.Models.Product", b =>
                {
                    ...
                    b.HasOne("ProductionAnalysisBackend.Models.ProductionAnalysis", "ProductionAnalysis")
                        .WithOne("Product")
                        .HasForeignKey("ProductionAnalysisBackend.Models.Product", "ProductionAnalysisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
